...
# -------------------- Beschreibung --------------------
st.write(
    "StudyBuddy wurde entwickelt, um Schülerinnen und Schüler bei der "
    "Organisation ihres Lernalltags zu unterstützen. Viele Lernende "
    "verlieren im Schulalltag schnell den Überblick über Aufgaben, "
    "Prüfungen und Lernzeiten."
)
